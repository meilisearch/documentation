  ...
  --data-binary '{
    ...
    "remotes": {
      "ms-00": {
        ...
        "writeApiKey": "INSTANCE_API_KEY"
      },
      "ms-01": {
        "url": "http://ANOTHER_INSTANCE_URL",
        "searchApiKey": "ANOTHER_INSTANCE_API_KEY",
        "writeApiKey": "ANOTHER_INSTANCE_API_KEY"
      },
      "ms-02": {
        "url": "http://YET_ANOTHER_INSTANCE_URL",
        "searchApiKey": "YET_ANOTHER_INSTANCE_API_KEY",
        "writeApiKey": "YET_ANOTHER_INSTANCE_API_KEY"
      }
    },
    "shards": {
      "s-a": {
