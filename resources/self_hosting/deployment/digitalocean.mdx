...
description: Deploy Meilisearch on a DigitalOcean droplet. Covers installation, server configuration, and securing your instance.
---
...
Remember to choose a [safe master key](/resources/self_hosting/security/basic_security#creating-the-master-key-in-a-self-hosted-instance) and avoid exposing it in publicly accessible locations.
