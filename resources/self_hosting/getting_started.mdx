...
Learn more about other installation options in the [installation guide](/resources/self_hosting/install_meilisearch_locally).
...
If you'd like to search through the documents you just added using a clean browser interface rather than the terminal, you can do so with [our built-in search preview](/resources/self_hosting/search_preview). You can also [learn how to quickly build a front-end interface](/guides/front_end/front_end_integration) of your own.
