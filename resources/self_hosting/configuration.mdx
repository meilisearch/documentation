...
- The [search preview interface](getting_started/search_preview) is disabled
...
Sets the maximum size of [accepted payloads](getting_started/documents#dataset-format). Value must be given in bytes or explicitly stating a base unit. For example, the default value can be written as `107374182400`, `'107.7Gb'`, or `'107374 Mb'`.
