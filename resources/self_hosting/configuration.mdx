...
- The [search preview interface](/getting_started/overview) is disabled
...
Notifies the configured URL whenever Meilisearch [finishes processing a task](/products/platform/tasks#task-status) or batch of tasks. Meilisearch uses the URL as given, retaining any specified query parameters.
