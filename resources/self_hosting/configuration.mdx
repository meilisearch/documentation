...
[Read more about our policy on data collection](resources/telemetry), or take a look at [the comprehensive list of all data points we collect](resources/telemetry#exhaustive-list-of-all-collected-data).
