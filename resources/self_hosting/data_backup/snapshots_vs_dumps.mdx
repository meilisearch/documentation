...
sidebarTitle: Snapshots and dumps
...
A snapshot is an exact copy of the Meilisearch database, located by default in `./data.ms`. [Use snapshots for quick and efficient backups of your instance](/resources/self_hosting/data_backup/snapshots).
