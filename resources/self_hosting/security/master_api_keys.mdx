...
API keys grant access to a specific set of indexes, routes, and endpoints. You can configure them to expire after a certain date. Use the [`/keys` route](/reference/api/keys/overview) to create, configure, and delete API keys.
...
<CardGroup cols={2}>
  <Card title="API keys reference" icon="key" href="/reference/api/keys/overview">
