...
- Use the **Default Chat API Key** for [conversational search](/capabilities/agentic_search/advanced/chats_api_fallback#find-your-chat-api-key) (can be safely used from the frontend)
