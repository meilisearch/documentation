...
sidebarTitle: Protected and unprotected projects
...
Consult the [basic security tutorial](/resources/self_hosting/security/basic_security) for instructions on how to communicate with protected projects.
