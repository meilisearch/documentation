...
When a remote is removed, Meilisearch triggers a `NetworkTopologyChange` task that automatically rebalances documents. Data held by the removed remote is exported and imported by the remaining remotes before being deleted.
