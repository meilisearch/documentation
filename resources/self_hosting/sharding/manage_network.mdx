...
description: Add remotes, update shard assignments, and manage your Meilisearch network topology dynamically.
---
...
Include the new remote in the `remotes` object and update the shard assignments to include it:
...
Send a new `shards` configuration with the full `remotes` list for each shard you want to update. Shards not included in the request are left unchanged:
