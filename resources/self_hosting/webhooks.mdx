...
This guide teaches you how to configure a single webhook via instance options to notify a URL when Meilisearch completes a [task](/products/platform/asynchronous_operations).
