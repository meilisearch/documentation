...
Meilisearch provides a built-in [MCP server](/getting_started/integrations/mcp) for connecting LLM clients and IDEs to your indexes.

<CardGroup cols={1}>
  <Card title="MCP" icon="sparkles" href="/getting_started/integrations/mcp">
    Search your Meilisearch indexes from AI agents and LLM clients
  </Card>
</CardGroup>
...
<CardGroup cols={3}>
  <Card title="JavaScript" icon="/assets/images/integrations/typescript.svg" href="https://github.com/meilisearch/meilisearch-js">
    TypeScript client
  </Card>
  ...
  <Card title="Ruby" icon="/assets/images/integrations/ruby.svg" href="https://github.com/meilisearch/meilisearch-ruby">
    Ruby client
  </Card>
  ...
  <Card title=".NET" icon="/assets/images/integrations/dotnet.svg" href="https://github.com/meilisearch/meilisearch-dotnet">
    .NET client
  </Card>
  <Card title="Dart" icon="/assets/images/integrations/dart.svg" href="https://github.com/meilisearch/meilisearch-dart">
    Dart client
  </Card>
</CardGroup>
...
<CardGroup cols={1}>
  ...
  <Card title="Ruby on Rails" icon="/assets/images/integrations/rails.svg" href="https://github.com/meilisearch/meilisearch-rails">
...
<CardGroup cols={2}>
  <Card title="Strapi" icon="/assets/images/integrations/strapi.svg" href="https://github.com/meilisearch/strapi-plugin-meilisearch">
    Sync your Strapi v5 collections to Meilisearch
  </Card>
  <Card title="Firebase" icon="/assets/images/integrations/firebase.svg" href="https://github.com/meilisearch/firestore-meilisearch">
