...
| [Queue documents fetch](/reference/api/async-task-management/get-tasks-document-payload)                                                       | Force document fetch routes to wait in the search queue when no thread is available | API route |
