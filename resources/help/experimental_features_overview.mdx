...
description: This article covers how to activate and configure Meilisearch experimental features.
---

import CodeSamplesUpdateExperimentalFeatures1 from '/snippets/generated-code-samples/code_samples_update_experimental_features_1.mdx';
...
2. Those that are activated with the [`/experimental-features` API route](/reference/api/management/list-experimental-features).
...
Some experimental features can be activated via an HTTP call using the [`/experimental-features` API route](/reference/api/management/list-experimental-features):
...
| [Drop search after](/resources/self_hosting/configuration)                         | Drop irrelevant search requests after a configurable timeout (default: 60s) | CLI flag or environment variable           |
| [Searches per core](/resources/self_hosting/configuration)                         | Configure number of concurrent search requests per CPU core (default: 4)   | CLI flag or environment variable            |
...
| [Allowed IP networks](/resources/self_hosting/configuration)                       | Override default IP policy with allowed CIDR ranges                        | CLI flag or environment variable            |
