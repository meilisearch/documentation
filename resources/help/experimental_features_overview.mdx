...
| [Edit documents with function](/reference/api/documents/edit-documents-by-function)         | Use a [Rhai](https://rhai.rs/book/) function to edit documents directly in the Meilisearch database | API route                                   |
