...
It is possible to [access previous versions of the Meilisearch documentation website](/resources/migration/previous_docs_version), but the process and results are less than ideal. Users are strongly encouraged to always use the latest Meilisearch release.
