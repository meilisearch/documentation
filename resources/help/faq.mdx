...
Yes. Meilisearch supports [multitenancy with tenant tokens](/capabilities/platform/security/overview), which let you control which documents each user can search without maintaining separate indexes.
