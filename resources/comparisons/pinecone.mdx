...
- [AI-powered search guide](/products/ai_powered_search/getting_started) - Set up hybrid search
- [Embedder configuration](/products/ai_powered_search/choose_an_embedder) - Connect to embedding providers
- [Hybrid search](/products/ai_powered_search/difference_full_text_ai_search) - Understand the approach
