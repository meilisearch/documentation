...
|---|:---:|:----:|:---:|:---:|
| API Key Management | ✅ | ✅ | ✅ | ✅ |
| Tenant tokens & multi-tenant indexes | ✅ <br /> [Multitenancy support](/products/platform/multitenancy_tenant_tokens) | ✅ | ✅ | ✅ <br /> Role-based |
...
| Monitoring Dashboard | ✅ <br /> [Cloud product](https://www.meilisearch.com/docs/products/analytics/overview) | ✅ <br /> Cloud Product | ✅ <br /> Cloud Product | ✅ <br /> Cloud Product |
...
- [Features](getting_started/what_is_meilisearch#features) such as search-as-you-type, typo tolerance, faceting, etc.
