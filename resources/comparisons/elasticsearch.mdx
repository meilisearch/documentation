...
| **Open source** | MIT license | AGPL / SSPL (source-available) |
...
### Your dataset fits on a single node

For most application search use cases, Elasticsearch's distributed architecture is overkill. Meilisearch handles datasets of hundreds of millions of documents on a single server with consistent sub-50ms response times, though the exact limit depends on document size, ranking rules, and hardware.
...
- [Meilisearch quick start](/learn/getting_started/cloud_quick_start) - Get up and running in minutes
- [Indexing documents](/learn/getting_started/documents) - Learn how to import your data
- [Search preview](/learn/getting_started/search_preview) - Explore search capabilities
