...
Meilisearch offers built-in [conversational search](/capabilities/agentic_search/overview) that lets users interact with your data through natural language chat, powered by LLMs and grounded in your indexed documents. Typesense does not offer a comparable feature.
...
- [Conversational search](/capabilities/agentic_search/overview) - Built-in chat grounded in your data
