...
Meilisearch supports [agentic search](/capabilities/agentic_search/overview) so users can interact with your data through natural language chat, powered by LLMs and grounded in your indexed documents. The recommended integration is [`@meilisearch/ai-sdk`](/getting_started/integrations/ai_sdk). The engine also exposes an experimental [`/chats` API](/capabilities/agentic_search/advanced/chats_api). Typesense does not offer a comparable feature.
...
- [Agentic search](/capabilities/agentic_search/overview) - AI agents and chat grounded in your data
