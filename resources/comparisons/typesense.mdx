...
Meilisearch offers built-in [conversational search](/learn/chat/getting_started_with_chat) that lets users interact with your data through natural language chat, powered by LLMs and grounded in your indexed documents. Typesense does not offer a comparable feature.
...
- [AI-powered search](/learn/ai_powered_search/getting_started_with_ai_search) - Hybrid and semantic search capabilities
- [Conversational search](/learn/chat/getting_started_with_chat) - Built-in chat grounded in your data
- [Language support](/resources/help/language) - Supported languages and tokenization
- [Sharding](/learn/multi_search/implement_sharding) - Scale beyond a single node
