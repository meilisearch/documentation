...
For a high-level comparison of the two search companies and their products, see [our analysis of the search market](/resources/comparison_to_alternatives#meilisearch-vs-algolia).
...
To customize your index settings, we recommend following [this guide](/resources/glossary/indexes#index-settings). To learn more about the differences between settings in Algolia and Meilisearch, read on.
