...
To customize your index settings, we recommend following [this guide](getting_started/indexes#index-settings). To learn more about the differences between settings in Algolia and Meilisearch, read on.
