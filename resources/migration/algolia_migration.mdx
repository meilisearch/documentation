...
For a high-level comparison of the two search companies and their products, see [our analysis of the search market](/resources/help/comparison_to_alternatives#meilisearch-vs-algolia).
...
| `separatorsToIndex`                 | [`separatorTokens`](/reference/api/settings/get-separatortokens) / [`nonSeparatorTokens`](/reference/api/settings/get-nonseparatortokens) |
