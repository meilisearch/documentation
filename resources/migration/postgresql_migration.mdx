...
To customize your index settings, see [configuring index settings](/learn/getting_started/indexes#index-settings). To understand the differences between PostgreSQL full-text search and Meilisearch, read on.
