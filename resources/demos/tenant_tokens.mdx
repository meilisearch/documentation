...
<CardGroup cols={2}>
  ...
  <Card title="Tenant tokens guide" icon="key" href="/learn/security/multitenancy_tenant_tokens">
...
<CardGroup cols={2}>
  <Card title="Generate tokens" icon="code" href="/learn/security/generate_tenant_token_sdk">
    SDK token generation
  </Card>
  <Card title="Security overview" icon="shield" href="/learn/security/basic_security">
