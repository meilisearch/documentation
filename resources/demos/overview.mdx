...
<CardGroup cols={2}>
  <Card title="Cloud quick start" icon="cloud" href="/learn/getting_started/cloud_quick_start">
...
Demo source code is available on GitHub, with most demos in the [meilisearch/demos](https://github.com/meilisearch/demos) repository and some in dedicated repos linked from each demo page.
