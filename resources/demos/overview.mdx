...
<Card title="Agentic movie search" icon="robot" href="/resources/demos/agentic_movie_search">
  An agent that writes its own queries against the movies index to recommend films.
</Card>

<Card title="Talk with Lex" icon="podcast" href="/resources/demos/talk_with_lex">
  Find any moment of the Lex Fridman Podcast and chat with every transcript.
</Card>

<Card title="Judilibre legal search" icon="scale-balanced" href="/resources/demos/judilibre">
  French codes and case law with hybrid search and a conversational assistant.
</Card>

<Card title="Paperscope" icon="book-open" href="/resources/demos/paperscope">
  Hybrid search, similar papers, and chat across 6,000 AI research papers.
</Card>
...
<Card title="HackerSearch" icon="newspaper" href="/resources/demos/hackersearch">
  Every Hacker News story and comment with faceted search and live sync.
</Card>
