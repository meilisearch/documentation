...
Hannoy integrates with Meilisearch's filtering using [RoaringBitmaps](/getting_started/glossary/roaring_bitmap):
...
- [AI-powered search](/products/hybrid_search/getting_started): Using vector search in Meilisearch
- [ANN](/getting_started/glossary/ann): Approximate nearest neighbors explained
- [Vector embeddings](/getting_started/glossary/vector_embeddings): What embeddings are
- [Hybrid search](/getting_started/glossary/hybrid_search): Combining vector and keyword search
- [LMDB](/getting_started/glossary/lmdb): The storage backend
