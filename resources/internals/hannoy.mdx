---
title: "Vector storage: DiskANN"
sidebarTitle: Vector storage
description: How Meilisearch stores and searches vector embeddings using a disk-backed DiskANN approach, implemented through its Hannoy library for fast and scalable vector search.
---
