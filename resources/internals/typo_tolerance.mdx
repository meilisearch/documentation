...
| **Language-aware normalization before typo** | Yes, built-in (Charabia) | Yes, configurable (analyzer framework — more powerful but requires expertise) | Yes, configurable (analyzers) | No | No |
