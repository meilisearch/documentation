...
## What's the difference between dumps and snapshots?

Meilisearch has two ways to backup its data: [`dumps`](/learn/data_backup/dumps) and [`snapshots`](/learn/data_backup/snapshots).
...
- Not all attributes need to be [searchable](/learn/configuration/displayed_searchable_attributes#searchable-fields). Avoid indexing unique IDs.
