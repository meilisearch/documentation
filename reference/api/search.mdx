...
| **[`attributesToSearchOn`](#select-attributes-to-search)**            | Array of strings           | `null`        | Restrict search to a subset of document fields |
...
Configures a subset of search fields for a given query. `attributesToSearchOn` limits search only to the specified attributes.
