...
Defines one attributes as a distinct attribute. Distinct attributes indicate certain documents are equivalent and that only one of them should be returned in search results.
