...
<Capsule intent="note">
The ranking score of a document is independent of other documents in the index. Adding documents to an index does not change the ranking score of existing documents.
</Capsule>
