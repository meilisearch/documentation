...
<CodeSamples id="experimental_search_parameter_guide_hybrid_1" />
...
<CodeSamples id="experimental_search_parameter_guide_vector_1" />
...
<CodeSamples id="experimental_search_parameter_reference_retrieve_vectors_1" />
