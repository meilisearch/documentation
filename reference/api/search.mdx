...
`frequency` gives more weight to terms that appear less frequently in the set of results. Meilisearch will prioritize terms that differentiate a document from other, very similar documents.
