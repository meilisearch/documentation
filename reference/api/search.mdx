...
<Capsule intent="note">
By default, [this endpoint returns a maximum of 1000 results](/learn/advanced/known_limitations#maximum-number-of-results-per-search). If you want to scrape your database, use the [get documents endpoint](/reference/api/documents#get-documents) instead.
</Capsule>
...
>>>>>>> 37fecd471 (components: warning to Capsule)
...
>>>>>>> a92b8f772 (components: tip to Capsule)
...
>>>>>>> 3fedb941d (migrate v1.1 changes)
...
>>>>>>> 3fedb941d (migrate v1.1 changes)
<Capsule intent="note">
>>>>>>> 74c8fc73b (components: ::: note to Capsule)
...
=======
[Learn more about facet distribution in the faceted search guide.](/learn/advanced/faceted_search.md#configuring-and-using-facets)
>>>>>>> 3fedb941d (migrate v1.1 changes)
=======
