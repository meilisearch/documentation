...
`frequency` gives more weight to the less frequent words, making the search engine focus on the words that differentiate a document from other, very similar documents.
