...
| **[`filter`](/reference/api/search#filter)**            | [String](/learn/filtering_and_sorting/filter_search_results#filter-expressions) | `null`        | Filter queries by an attribute's value              |
...
This endpoint only accepts [string filter expressions](/learn/filtering_and_sorting/filter_search_results#filter-expressions).
</Capsule>
...
[Read more about sorting search results in our dedicated guide.](/learn/filtering_and_sorting/sorting)
