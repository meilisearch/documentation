...
Configures a query to only look for terms in a subset of your index's `searchableAttributes`. The order of attributes passed to `attributesToSearchOn` does not affect relevancy.
