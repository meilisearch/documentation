...
You can <a href="https://www.meilisearch.com/docs/assets/engine-release-assets/meilisearch-openapi.json" download="meilisearch-openapi.json">download the OpenAPI specification</a> for the latest Meilisearch version.
