...
| **`filter`**    | N/A           | An array of array of strings for refining results based on attributes in the `filterableAttributes` list |
...
<Capsule intent="warning">
Sending an empty payload will return a `bad_request` error.
</Capsule>
