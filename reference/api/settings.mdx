...
With Meilisearch, you can create [faceted search interfaces](/learn/filtering_and_sorting/faceted_search). This setting allows you to define the maximum number of values returned by the `facets` search parameter.
...
[To learn more about filterable attributes, refer to our dedicated guide.](/learn/filtering_and_sorting/filtering)
