...
Pooling refers to one of the last steps in embedding generation. During this phase, the multiple embeddings for individual tokens are merged into a single embedding. Most models indicate which pooling method they expect.
