...
| :--------------------------------------------------- | :--------------- | :----------------------------------------------------------------------------------------------- | :------------------------------------------------------------------------------- |
| **[`dictionary`](#user-defined-dictionary)**         | Array of strings | Empty                                                                                            | List of strings Meilisearch should parse as a single term                        |
...
In languages where words are not separated by spaces such as Japanese, Meilisearch relies on dictionaries to delimit where one term begins and ends. This setting allows users to instruct Meilisearch to consider groups of strings as a single term by adding dictionaries of user-defined terms.
...
Get the index's user-defined dictionary.
...
Update the index's user-defined dictionary.
...
Reset the index's dictionary to its default value, `[]`.
