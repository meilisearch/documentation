...
With Meilisearch, you can create [faceted search interfaces](/learn/fine_tuning_results/faceted_search). This setting allows you to define the maximum number of values returned by the `facets` search parameter.
