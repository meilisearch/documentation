...
```json
{
  "default": {
    ...
    "documentTemplateMaxBytes": <String>,
    "dimensions": <Integer>,
    "revision": <String>,
    "distribution": {
      "mean": <Float>,
...
When set to `true`, compresses vectors by representing each dimension with 1-bit values. This reduces relevancy of semantic search results, but greatly reduces database size.
