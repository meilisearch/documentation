...
Reset an index's faceting settings to their [default value](#faceting-object). Setting `sortFacetValuesBy` to `null`, will restore it to the default value (`"*": "alpha"`).
