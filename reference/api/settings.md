...
With Meilisearch, you can create [faceted search interfaces](/learn/advanced/faceted_search.md). This setting allows you to define the maximum number of values returned by the `facets` search parameter.

[To learn more about filtering and faceting, refer to our dedicated guide.](/learn/advanced/faceted_search.md)
