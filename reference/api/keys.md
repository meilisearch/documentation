...
An alphanumeric key value generated by MeiliSearch on API key creation. Used for authorization when [making calls to a protected MeiliSearch instance](/reference/features/security.md#communicating-with-a-protected-instance).
