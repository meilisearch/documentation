...
| **`indexes.swap`**     | Provides access to the swap indexes endpoint. **Non-authorized `indexes` will be omitted from the response**                                                                                                                                                                 |
...
| **`tasks.cancel`**     | Provides access to the [cancel tasks](/reference/api/tasks.md#cancel-tasks) endpoint. **Tasks from non-authorized `indexes` will be omitted from the response**                                                                                                                  |
| **`tasks.delete`**     | Provides access to the [delete tasks](/reference/api/tasks.md#delete-tasks) endpoint. **Tasks from non-authorized `indexes` will be omitted from the response**                                                                                                                  |
