...
```bash
curl \
  -H 'Authorization: Bearer masterKeyGoesHere'
  …
```
...
| --------------- | ---------------------------------------------------------------------------- |
| **key**         | Alphanumeric value generated by MeiliSearch on [key creation](#create-a-key) |
...
An alphanumeric key value generated by MeiliSearch on API key creation. Used for authorization when [making calls to a protected MeiliSearch instance](/reference/features/authentication.md#communicating-with-a-protected instance).
