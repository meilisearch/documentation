...
Meilisearch CRM demo uses multi-search to allow searching through contacts, deals, and companies via a unified search bar. Check it out the [preview](https://saas.meilisearch.com/?utm_campaign=oss&utm_source=docs&utm_medium=multi-search-api) or the [Github repository](https://github.com/meilisearch/ecommerce-demo/).
