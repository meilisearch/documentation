...
Meilisearch CRM SaaS demo uses multi-search to allow searching through contacts, deals, and companies via a unified search bar. Check out the [SaaS demo](https://saas.meilisearch.com/?utm_campaign=oss&utm_source=docs&utm_medium=multi-search-api) and the [Github repository](https://github.com/meilisearch/saas-demo/).
