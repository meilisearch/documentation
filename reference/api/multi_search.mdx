...
| **`queries`** | Array of objects | Contains the list of search queries to perform. The [`indexUid`](getting_started/indexes#index-uid) search parameter is required, all other parameters are optional |
...
| **[`indexUid`](getting_started/indexes#index-uid)**                   | String           | N/A           | `uid` of the requested index                        |
...
| Name                     | Type             | Description                                                                      |
| :----------------------- | :--------------- | :------------------------------------------------------------------------------- |
| **`indexUid`**           | String           | [`uid`](getting_started/indexes#index-uid) of the requested index         |
