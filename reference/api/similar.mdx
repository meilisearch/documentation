...
| ---------------------------------------------------------------------------- | ---------------- | ------------- | ---------------------------------------------- |
| **`id`**                                                                     | String or number | `null`        | ID of the target document (mandatory)          |
| **[`embedder`](/reference/api/search#embedder)**                             | String           | `"default"`   | Embedder to use when computing recommendations |
...
| **[`rankingScoreThreshold`](/reference/api/search#ranking-score-threshold)** | Number           | `false`       | Exclude results with low ranking scores        |
