...
| **`rawDocumentDbSize`**         | Integer | Total size of documents in the database, in bytes                                                            |
| **`maxDocumentSize`**           | Integer | Size of the largest document in the database, in bytes                                                       |
| **`avgDocumentSize`**           | Integer | Total size of documents in the database divided by the number of documents in the database, in bytes         |
