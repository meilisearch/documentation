...
import CodeSamplesExperimentalGetMetrics1 from '/snippets/generated-code-samples/code_samples_experimental_get_metrics_1.mdx';
...
Refer to Meilisearch's sample configuration files, for example, this [Grafana dashboard](https://github.com/meilisearch/meilisearch/blob/main/assets/grafana-dashboard.json).
