...
**Limitation:** MeiliSearch can index a maximum of __65,536 attributes per document. If a document contains more than 65,536 attributes, an error will be thrown.
