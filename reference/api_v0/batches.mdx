...
The `/batches` route gives information about the progress of batches of [asynchronous operations](/products/platform/tasks).
...
Batch results are [paginated](/products/platform/tasks#paginating-tasks) and can be [filtered](/products/platform/tasks#filtering-tasks) with query parameters.
