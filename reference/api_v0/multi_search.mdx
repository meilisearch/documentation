...
| **`queries`** | Array of objects | Contains the list of search queries to perform. The [`indexUid`](/getting_started/glossary/indexes#index-uid) search parameter is required, all other parameters are optional |
...
| :--------------------------------------------------------------------------- | :--------------- | :------------ | :-------------------------------------------------- |
| **[`offset`](/reference/api/indexes/search-with-post#offset)**                                 | Integer          | `0`           | Number of documents to skip                         |
| **[`limit`](/reference/api/indexes/search-with-post#limit)**                                   | Integer          | `20`          | Maximum number of documents returned                |
...
- `maxValuesPerFacet`: must be an integer. When specified, indicates the maximum number of returned values for a single facet. Defaults to the value assigned to [the `maxValuesPerFacet` index setting](/reference/api/settings/get-faceting)
...
| **[`indexUid`](/getting_started/glossary/indexes#index-uid)**                   | String           | N/A           | `uid` of the requested index                        |
| **[`q`](/reference/api/indexes/search-with-post#query-q)**                                     | String           | `""`          | Query string                                        |
| **[`offset`](/reference/api/indexes/search-with-post#offset)**                                 | Integer          | `0`           | Number of documents to skip                         |
| **[`limit`](/reference/api/indexes/search-with-post#limit)**                                   | Integer          | `20`          | Maximum number of documents returned                |
| **[`hitsPerPage`](/reference/api/indexes/search-with-post#number-of-results-per-page)**        | Integer          | `1`           | Maximum number of documents returned for a page     |
| **[`page`](/reference/api/indexes/search-with-post#page)**                                     | Integer          | `1`           | Request a specific page of results                  |
| **[`filter`](/reference/api/indexes/search-with-post#filter)**                                 | String           | `null`        | Filter queries by an attribute's value              |
| **[`facets`](/reference/api/indexes/search-with-post#facets)**                                 | Array of strings | `null`        | Display the count of matches per facet              |
| **[`distinct`](/reference/api/indexes/search-with-post#distinct-attributes-at-search-time)**   | String           | `null`        | Restrict search to documents with unique values of specified attribute |
| **[`attributesToRetrieve`](/reference/api/indexes/search-with-post#attributes-to-retrieve)**   | Array of strings | `["*"]`       | Attributes to display in the returned documents     |
| **[`attributesToCrop`](/reference/api/indexes/search-with-post#attributes-to-crop)**           | Array of strings | `null`        | Attributes whose values have to be cropped          |
| **[`cropLength`](/reference/api/indexes/search-with-post#crop-length)**                        | Integer          | `10`          | Maximum length of cropped value in words            |
| **[`cropMarker`](/reference/api/indexes/search-with-post#crop-marker)**                        | String           | `"…"`         | String marking crop boundaries                      |
| **[`attributesToHighlight`](/reference/api/indexes/search-with-post#attributes-to-highlight)** | Array of strings | `null`        | Highlight matching terms contained in an attribute  |
| **[`highlightPreTag`](/reference/api/indexes/search-with-post#highlight-tags)**                | String           | `"<em>"`      | String inserted at the start of a highlighted term  |
| **[`highlightPostTag`](/reference/api/indexes/search-with-post#highlight-tags)**               | String           | `"</em>"`     | String inserted at the end of a highlighted term    |
| **[`showMatchesPosition`](/reference/api/indexes/search-with-post#show-matches-position)**     | Boolean          | `false`       | Return matching terms location                      |
| **[`sort`](/reference/api/indexes/search-with-post#sort)**                                     | Array of strings | `null`        | Sort search results by an attribute's value         |
| **[`matchingStrategy`](/reference/api/indexes/search-with-post#matching-strategy)**            | String           | `last`        | Strategy used to match query terms within documents |
| **[`showRankingScore`](/reference/api/indexes/search-with-post#ranking-score)**                | Boolean          | `false`       | Display the global ranking score of a document      |
| **[`showRankingScoreDetails`](/reference/api/indexes/search-with-post#ranking-score-details)** | Boolean          | `false`       | Adds a detailed global ranking score field          |
| **[`rankingScoreThreshold`](/reference/api/indexes/search-with-post#ranking-score-threshold)** | Number           | `null`        | Excludes results with low ranking scores            |
| **[`attributesToSearchOn`](/reference/api/indexes/search-with-post#customize-attributes-to-search-on-at-search-time)** | Array of strings | `["*"]` | Restrict search to the specified attributes |
| **[`hybrid`](/reference/api/indexes/search-with-post#hybrid-search)**                          | Object           | `null`        | Return results based on query keywords and meaning  |
| **[`vector`](/reference/api/indexes/search-with-post#vector)**                                 | Array of numbers | `null`        | Search using a custom query vector                  |
| **[`retrieveVectors`](/reference/api/indexes/search-with-post#display-_vectors-in-response)**  | Boolean          | `false`       | Return document vector data                         |
| **[`locales`](/reference/api/indexes/search-with-post#query-locales)**                         | Array of strings | `null`        | Explicitly specify languages used in a query        |

Unless otherwise noted, search parameters for multi-search queries function exactly like [search parameters for the `/search` endpoint](/reference/api/indexes/search-with-post#search-parameters).
...
- `remote` <NoticeTag type="experimental" label="experimental" />: indicates the remote instance where Meilisearch will perform the query. Must be a string corresponding to a [remote object](/reference/api/network/overview). Defaults to `null`
...
| Name                     | Type             | Description                                                                      |
| :----------------------- | :--------------- | :------------------------------------------------------------------------------- |
| **`indexUid`**           | String           | [`uid`](/getting_started/glossary/indexes#index-uid) of the requested index         |
...
| **`facetDistribution`**  | Object           | **[Distribution of the given facets](/reference/api/indexes/search-with-post#facetdistribution)**  |
| **`facetStats`**         | Object           | [The numeric `min` and `max` values per facet](/reference/api/indexes/search-with-post#facetstats) |
