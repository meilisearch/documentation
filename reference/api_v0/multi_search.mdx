...
| **`queries`** | Array of objects | Contains the list of search queries to perform. The [`indexUid`](/resources/glossary/indexes#index-uid) search parameter is required, all other parameters are optional |
...
| **[`indexUid`](/resources/glossary/indexes#index-uid)**                   | String           | N/A           | `uid` of the requested index                        |
...
| Name                     | Type             | Description                                                                      |
| :----------------------- | :--------------- | :------------------------------------------------------------------------------- |
| **`indexUid`**           | String           | [`uid`](/resources/glossary/indexes#index-uid) of the requested index         |
