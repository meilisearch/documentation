...
When Meilisearch finishes processing a task, it sends the relevant [task object](/reference/api/tasks/overview#task-object) to all configured webhooks.
...
Create a new webhook. When Meilisearch finishes processing a task, it sends the relevant [task object](/reference/api/tasks/overview#task-object) to all configured webhooks.
