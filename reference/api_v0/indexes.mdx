...
| :--------------- | :-------------- | :------------ | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **`uid`**        | String          | N/A           | [Unique identifier](/resources/glossary/indexes#index-uid) of the index. Once created, it cannot be changed                                                                                                                                                |
...
| **`primaryKey`** | String / `null` | `null`        | [Primary key](/resources/glossary/primary_key#primary-field) of the index. If not specified, Meilisearch [guesses your primary key](/resources/glossary/primary_key#meilisearch-guesses-your-primary-key) from the first document you add to the index |
...
| Name             | Type            | Default value | Description                                                                               |
| :--------------- | :-------------- | :------------ | :---------------------------------------------------------------------------------------- |
| **`uid`** *      | String          | N/A           | [`uid`](/resources/glossary/indexes#index-uid) of the requested index                 |
| **`primaryKey`** | String / `null` | `null`        | [`Primary key`](/resources/glossary/primary_key#primary-field) of the requested index |
...
Update an index's [primary key](/resources/glossary/primary_key#primary-key). You can freely update the primary key of an index as long as it contains no documents.
...
| Name               | Type            | Default value | Description                                                                               |
| :----------------- | :-------------- | :------------ | :---------------------------------------------------------------------------------------- |
| **`primaryKey`** * | String / `null` | N/A           | [`Primary key`](/resources/glossary/primary_key#primary-field) of the requested index |
...
[To learn more about index swapping, refer to this short guide.](/resources/glossary/indexes#swapping-indexes)
