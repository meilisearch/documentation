...
The `/experimental-features` route allows you to activate or deactivate some of Meilisearch's [experimental features](/resources/help/experimental_features).
...
<Warning>
The experimental API route is not compatible with all experimental features. Consult the [experimental feature overview](/resources/help/experimental_features) for a compatibility list.
</Warning>
