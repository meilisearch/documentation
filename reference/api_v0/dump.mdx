...
[Learn more about dumps](/resources/self_hosting/data_backup/dumps).

## Create a dump

<RouteHighlighter method="POST" path="/dumps" />

Triggers a dump creation task. Once the process is complete, a dump is created in the [dump directory](/resources/self_hosting/configuration#dump-directory). If the dump directory does not exist yet, it will be created.
