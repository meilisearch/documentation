...
<Warning>
This endpoint will not work without first explicitly adding attributes to the [`filterableAttributes`](/reference/api/settings/filterable-attributes#update-filterable-attributes) list. [Learn more about facets in our dedicated guide.](/products/faceted_search/search_with_facet_filters)
</Warning>
...
| **[`filter`](/reference/api/search#filter)**                                                          | [String*](/products/faceted_search/filter_expression_reference) | `null`        | Filter queries by an attribute's value                                                                                                             |
