...
A document exceeds the [maximum limit of 65,535 fields](/learn/inner_workings/known_limitations#maximum-number-of-attributes-per-document).
...
The value of [displayed attributes](/learn/index_settings/displayed_searchable_attributes#displayed-fields) is invalid. It should be an empty array, an array of strings, or set to `null`.

## `invalid_settings_distinct_attribute`

The value of [distinct attributes](/learn/index_settings/distinct) is invalid. It should be a string or set to `null`.
