...
The [`filter`](/reference/api/documents#query-parameters) parameter is invalid. It should be a string, array of strings, or array of array of strings.

## `invalid_document_delete_filter`

The [`filter`](/reference/api/documents#delete-documents-by-filter) parameter is either empty or invalid. It should be a string, array of strings, or array of array of strings.
