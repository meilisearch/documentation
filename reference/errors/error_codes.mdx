...
- The [filter expression](/learn/filtering_and_sorting/filtering#filter-expressions) has a missing or invalid operator. [Read more about our supported operators](/learn/filtering_and_sorting/filtering#filter-operators)
