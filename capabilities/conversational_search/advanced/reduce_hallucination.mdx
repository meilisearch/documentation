...
Configure guardrails through the [chat workspace settings](/capabilities/conversational_search/advanced/chats_api_fallback#workspace-settings) or the Meilisearch Cloud UI. Available guardrails include:
...
<CardGroup cols={2}>
  ...
  <Card title="Configure a chat workspace" href="/capabilities/conversational_search/advanced/chats_api_fallback#workspace-settings">
