...
Each index has chat-specific settings that control how documents are prepared for the LLM. Configure these through the [index chat settings](/capabilities/conversational_search/advanced/chats_api_fallback#index-chat-settings) endpoint:
...
<CardGroup cols={2}>
  ...
  <Card title="Configure index chat settings" href="/capabilities/conversational_search/advanced/chats_api_fallback#index-chat-settings">
