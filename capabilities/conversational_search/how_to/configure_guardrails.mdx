...
- [Configure a chat workspace](/capabilities/conversational_search/advanced/chats_api_fallback#workspace-settings) to apply your guardrails
...
- Learn about [chat tools](/capabilities/conversational_search/advanced/chats_api_fallback#tools-reference) to enhance the user experience
