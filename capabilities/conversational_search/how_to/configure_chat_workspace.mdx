...
<Note>
On Meilisearch Cloud, the default workspace name is `cloud`. Use `/chats/cloud/settings` in API calls. If you need additional workspaces, [contact us](https://www.meilisearch.com/contact).
</Note>
