...
Since the system prompt controls the answer style, we recommend creating a dedicated workspace for summarization rather than reusing a chat workspace. This keeps the prompts separate and avoids affecting other use cases.
