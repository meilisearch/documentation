...
| Create and manage [API keys](/capabilities/platform/security/how_to/manage_api_keys) | Yes | Yes |
...
<CardGroup cols={2}>
  <Card title="Getting started" href="/capabilities/platform/teams/getting_started">
