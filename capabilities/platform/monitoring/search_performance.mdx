...
description: Monitor search latency percentiles, query throughput, and per-step search timing for your Meilisearch Cloud project.
---
...
<Frame>
  <img src="/assets/images/platform/monitoring/search_performance_trace.png" alt="Search preview showing Performance trace panel with per-step timing breakdown including semantic search at 98% of total time" />
</Frame>
...
Diagnosing search performance issues can be complex. Enterprise customers have direct access to the Meilisearch team, who can review your index configuration, query patterns, and performance traces to help you optimize for your specific workload. Contact [sales@meilisearch.com](mailto:sales@meilisearch.com) to learn more.
