...
Enterprise accounts can enable High Performance Disk on L tiers and above. It provides roughly 5x the IOPS and disk bandwidth of standard disk, which improves indexing throughput and search speed for disk-bound workloads. Contact [sales@meilisearch.com](mailto:sales@meilisearch.com) to enable it.
