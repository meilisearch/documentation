...
- The **source** instance must be running and contain the data you want to export.
- The **destination** instance must be reachable from the source over the network.
- If the destination instance uses an [API key](/capabilities/security/how_to/manage_api_keys), you must provide it in the export request.
