...
The `company_id` field in the Deals index links to the `id` field in the Companies index. Once configured, Meilisearch automatically hydrates the related document in search results.
