...
Meilisearch will rebuild your index after updating [`sortableAttributes`](/capabilities/filtering_sorting_faceting/how_to/sort_results). Depending on the size of your dataset, this might take some time.
