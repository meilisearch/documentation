...
- `indexUid` on each item in `actions.pin` scopes the pin to the document living in that index. If you omit it, Meilisearch treats the pin as a cross-index reference.
