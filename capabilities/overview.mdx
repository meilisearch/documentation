...
<CardGroup cols={2}>
  ...
  <Card title="Agentic search" icon="comments" href="/capabilities/agentic_search/overview">
    Let users and AI agents ask questions in natural language and get answers grounded in your data.
  </Card>
