...
The [facet search endpoint](/reference/api/facet-search/search-for-facet-values) lets users type to find specific facet values. This is the primary tool for handling high-cardinality facets.
...
<CardGroup cols={2}>
  ...
  <Card title="Facet search API reference" href="/reference/api/facet-search/search-for-facet-values">
