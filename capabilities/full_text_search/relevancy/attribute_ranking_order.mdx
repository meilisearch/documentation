...
If you manually configure [the searchable attributes list](/capabilities/full_text_search/relevancy/displayed_searchable_attributes#the-searchableattributes-list), attributes that appear early in the array are more important when calculating search result relevancy.
