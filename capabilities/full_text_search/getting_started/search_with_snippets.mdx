...
Use `attributesToHighlight` to specify which fields should have matched terms wrapped in highlight tags. Set it to `["*"]` to highlight all [displayed attributes](/capabilities/full_text_search/relevancy/displayed_searchable_attributes).
