...
- **High `search > evaluate query`**: complex query containing a lot of words or matching a lot of synonyms, generating a complex query tree that is expensive to evaluate. Add [stop words](/capabilities/full_text_search/how_to/configure_stop_words), reduce [synonyms](/capabilities/full_text_search/how_to/configure_synonyms) cardinality.
