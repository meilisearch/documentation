...
<Note>
Replication requires the Meilisearch Enterprise Edition v1.37 or later and a [configured network](/capabilities/replication_and_sharding/how_to/setup_sharded_cluster).
</Note>
