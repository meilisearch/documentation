...
Search personalization uses AI technology to re-rank search results at query time based on the user context you provide. It works alongside [full-text search](/capabilities/full_text_search/overview) and [hybrid search](/capabilities/hybrid_search/overview) to deliver results tailored to each user.
