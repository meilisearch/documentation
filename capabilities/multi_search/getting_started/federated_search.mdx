...
[Use the tasks endpoint](/capabilities/indexing/how_to/monitor_tasks) to check the indexing status. Once Meilisearch successfully indexed all three datasets, you are ready to perform a federated search.
