...
<CardGroup cols={3}>
  <Card title="Cohere" href="/capabilities/hybrid_search/how_to/configure_cohere_embedder">
  ...
  <Card title="TwelveLabs" href="/capabilities/hybrid_search/providers/twelvelabs">
