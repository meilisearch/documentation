...
<Tip>
For a complete, provider-specific walkthrough that also covers video clips and combined text and image queries, see [Multimodal search with TwelveLabs Marengo](/capabilities/hybrid_search/providers/twelvelabs).
</Tip>
