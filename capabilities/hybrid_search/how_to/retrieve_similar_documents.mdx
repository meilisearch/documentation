...
Meilisearch will start generating the embeddings for all movies in your dataset. Use the returned `taskUid` to [track the progress of this task](/capabilities/indexing/advanced/async_operations). Once it is finished, you are ready to start searching.
