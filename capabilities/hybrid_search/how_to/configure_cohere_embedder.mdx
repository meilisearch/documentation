...
- A running Meilisearch project (v1.3 or later)
- A [Cohere account](https://cohere.com/) with an API key
...
- `documentTemplate`: a [Liquid template](/capabilities/hybrid_search/getting_started) that converts your documents into text for embedding
