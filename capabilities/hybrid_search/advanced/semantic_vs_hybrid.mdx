...
- **Similarity-based use cases**: if you are building a recommendation system using the [`/similar` endpoint](/capabilities/hybrid_search/how_to/retrieve_similar_documents), you are already using pure vector similarity. Hybrid search does not apply.
