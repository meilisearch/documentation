...
See the [Chats API guide](/capabilities/agentic_search/advanced/chats_api) for setup, chat patterns, streaming, and tools. Consult the [chat completions API reference](/reference/api/chats/request-a-chat-completion) for the full list of supported parameters.
