...
- [Get started with the AI SDK](/capabilities/agentic_search/getting_started) to build an agent that returns source documents
- [Configure guardrails](/capabilities/agentic_search/how_to/configure_guardrails) so responses stay grounded in the sources you display
- [Handle errors and fallbacks](/capabilities/agentic_search/how_to/handle_errors_and_fallbacks) when a search returns no results
