...
- Learn about all available tools in the [Chats API tools reference](/capabilities/agentic_search/advanced/chats_api_fallback#tools-reference)
- [Configure guardrails](/capabilities/agentic_search/how_to/configure_guardrails) to improve response accuracy
- [Stream chat responses](/capabilities/agentic_search/advanced/chats_api_fallback#streaming) for real-time delivery
