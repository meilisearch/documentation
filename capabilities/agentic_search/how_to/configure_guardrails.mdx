...
const { text } = await generateText({
  ...
  system: "Your system prompt goes here here.",
  tools: {
...
```bash Chats completions API (experimental)
curl \
  ...
  --data-binary '{
    "prompts": {
      "system": "Your system prompt goeshere."
    }
  }'
```
...
- [Chats completions API](/capabilities/agentic_search/advanced/chats_api_fallback) for more information on the experimental feature
