...
Meilisearch Cloud provides built-in guardrail options for the experimental [Chats API](/capabilities/agentic_search/advanced/chats_api) through the workspace settings. These guardrails work by injecting carefully crafted instructions into the system prompt to guide the model's behavior.
...
Configure guardrails through the [chat workspace settings](/capabilities/agentic_search/advanced/chats_api#workspace-settings) or the Meilisearch Cloud UI. Available guardrails include:
...
<CardGroup cols={2}>
  ...
  <Card title="Configure a chat workspace" href="/capabilities/agentic_search/advanced/chats_api#workspace-settings">
