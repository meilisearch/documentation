...
The model decides whether and how many times to call `search` before answering. You can steer behavior by [prompt engineering](/capabilities/agentic_search/advanced/optimize_chat_prompts), [adding guardrails](/capabilities/agentic_search/how_to/configure_guardrails), and using the AI SDK to configure your agent's capabilities.
