...
MeiliSearch also offers an out-of-the-box [web interface](/guides/advanced_guides/web_interface.md) on which you can try the search. Simply go to your MeiliSearch address using a browser. In our case that would be: `http://127.0.0.1:7700`
