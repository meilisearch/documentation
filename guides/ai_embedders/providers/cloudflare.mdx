...
- `documentTemplate`: Optionally, you can provide a [custom template](/products/ai_powered_search/getting_started) for generating embeddings from your documents.
