...
If you prefer to use the self-hosted version of Meilisearch, you can follow the[ quick start](https://www.meilisearch.com/docs/learn/getting_started/quick_start) tutorial.
...
When you're ready to use your own data, make sure to configure your [index settings](/learn/configuration/settings) first to follow [best practices](/guides/performance/indexing_best_practices). For a full configuration example, see the [meilisearch-rails gem README](https://github.com/meilisearch/meilisearch-rails?tab=readme-ov-file#%EF%B8%8F-settings).
