...
Configure which attributes are [filterable](/learn/filtering_and_sorting/filter_search_results) and [sortable](/learn/filtering_and_sorting/sorting) via your Meilisearch index settings.
...
- [Sorting](/learn/filtering_and_sorting/sorting)
