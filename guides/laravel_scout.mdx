...
Configure which attributes are [filterable](/learn/filtering_and_sorting/filter_search_results) and [sortable](/learn/fine_tuning_results/sorting) via your Meilisearch index settings.
