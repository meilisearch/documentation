---
title: Deploy a Meilisearch instance on Google Cloud Platform's Compute Engine — Meilisearch documentation
description: Deploy and configure Meilisearch on GCP in just a few steps.
sidebarDepth: 3
---
...
The following guide will walk you through every step to deploy Meilisearch in a GCP Compute Engine instance. If you have any problems with our GCP image, please create an issue in [this repository](https://github.com/meilisearch/cloud-providers/).
...
![Page titled 'Images'](/assets/images/gcp/01.compute-engine.png)

- Click on "[+] CREATE IMAGE"

![Adding image name(permanent), source, and cloud storage file](/assets/images/gcp/02.image-info.png)
...
![meilisearch-example successfully imported](/assets/images/gcp/03.import-image.png)
...
![The meilisearch-v-X-X-X instance](/assets/images/gcp/04.create-instance.png)
...
![Selecting the 'E2' series and 'e2-medium (2 vCPU, 4 GB memory)' machine type](/assets/images/gcp/05.machine-configuration.png)
...
![Selecting the 'Balanced persistent disk' Boot disk type and 10GB Size](/assets/images/gcp/06.boot-disk.png)
...
![The meilisearch-gcp-test instance running successfully](/assets/images/gcp/07.instance-running.png)
...
![The my-gcp-instance domain](/assets/images/gcp/08.domain.png)
...
You're all set to use Meilisearch in production with GCP! If you have any problems with our GCP image, please create an issue in [this repository]( https://github.com/meilisearch/cloud-providers/).
