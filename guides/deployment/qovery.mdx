---
title: Deploy a Meilisearch instance on Qovery — Meilisearch documentation
...
<Frame>
  <img src="https://hub.qovery.com/img/heroku/heroku-2.png" alt="'Create Project' button" />
</Frame>
...
<Frame>
  <img src="https://hub.qovery.com/img/heroku/heroku-3.png" alt="'Create environment' button" />
</Frame>
...
<Frame>
  <img src="https://hub.qovery.com/img/rust/rust.png" alt="Choose your repository in the 'Create Application' pop-up" />
</Frame>
...
<Frame>
  <img src="https://hub.qovery.com/img/add-storage.png" alt="Set storage to 10GB SSD" />
</Frame>
...
<Frame>
  <img src="https://hub.qovery.com/img/heroku/heroku-1.png" alt="Choose 'Deploy' from the 'Actions' dropdown" />
</Frame>
