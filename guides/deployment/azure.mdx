...
![The Azure portal prompting for information to deploy Meilisearch](/assets/images/azure/01.azure-deploy-button.png)
...
![The Azure portal showing information about your Meilisearch deployment](/assets/images/azure/02.azure-output.png)
