---
title: Deploy a Meilisearch instance on Azure — Meilisearch documentation
description: Deploy Meilisearch on Azure using a simplified one-click deploy with default settings compatible with most use-cases.
sidebarDepth: 3
---
...
<Frame>
  <img src="/assets/images/azure/01.azure-deploy-button.png" alt="The Azure portal prompting for information to deploy Meilisearch" />
</Frame>
...
- "`Meilisearch_apikey`": This will be the [master key](/learn/security/basic_security) of your Meilisearch instance. While we generate a random key by default, we encourage you to set your own key
...
<Frame>
  <img src="/assets/images/azure/02.azure-output.png" alt="The Azure portal showing information about your Meilisearch deployment" />
</Frame>
