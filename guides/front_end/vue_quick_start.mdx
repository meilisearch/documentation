...
Use the following URL and API key to connect to a Meilisearch instance which contains data from Steam video games. Add the code below to the `App.vue` file.
...
![Vue app search UI with a search bar at the top and search results for four video games](/assets/images/react_quick_start/react-qs-search-ui.png)
