---
title: Improve relevancy when working with large documents — Meilisearch documentation
...
```sh
curl \
  -X PUT 'http://MEILISEARCH_URL/indexes/INDEX_NAME/settings/distinct-attribute' \
