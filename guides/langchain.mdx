...
<Frame>
  <img src="https://raw.githubusercontent.com/meilisearch/documentation/main/assets/images/vector-search/01-cloud-vector-store.png" alt="A section of the project overview interface titled 'Experimental features'. There are two options: 'Score details' and 'Vector store'. 'Vector store' is turned on." />
</Frame>
