...
| `MEILI_NO_ANALYTICS` | --no-analytics | Deactivates analytics. Analytics allows us to know how many users are using MeiliSearch, which versions and which platforms are used. This process is entirely anonymous. |                  |
