...
<Frame>
  <img src="/docs/assets/images/aws/01.launch-instances.png" alt="Page titled 'Instances'. Text in center of screen: You do not have any instances in this region" />
</Frame>
...
<Frame>
  <img src="/docs/assets/images/aws/02.select-ami.png" alt="Page titled: 'Step 1: Choose an Amazon Machine Image (AMI)'" />
</Frame>
...
<Frame>
  <img src="/docs/assets/images/aws/03.size-and-specs.png" alt="Page titled: 'Step 2: Choose an Instance Type'. Selecting the free tier eligible instance type" />
</Frame>
...
<Frame>
  <img src="/docs/assets/images/aws/04.instance-details.png" alt="Page titled 'Step 3: Configure Instance Details'. Important: You can launch multiple instances from the same AMI, request Spot instances to take advantage of lower pricing, and assign access management role to the instance." />
</Frame>
...
<Frame>
  <img src="/docs/assets/images/aws/05.storage.png" alt="Page titled 'Step 4: Add Storage'. Text at bottom of screen: Free tier eligible users can get up to 30GB of EBS General Purpose (SSD) or Magnetic storage." />
</Frame>
...
<Frame>
  <img src="/docs/assets/images/aws/06.tags.png" alt="Page titled 'Step 5: Add Tags'. Text in center of screen: Make sure your IAM policy includes permissions to create tags. " />
</Frame>
...
<Frame>
  <img src="/docs/assets/images/aws/07.security.png" alt="Page titled 'Step 6: Configure Security group'. Warning: Rules with sources of 0.0.0.0/0 allow all IP addresses to access your instance. We recommend setting security group rules to allow access from known IP addresses only." />
</Frame>
...
<Frame>
  <img src="/docs/assets/images/aws/08.key-pair.png" alt="A popup titled: 'Select an existing key pair or create a new key pair'. Inside the popup, there is a form that allows you to configure key pairs. It also contains a warning: 'Download and store your private key file in a secure accessible location. You cannot download it again once it has been created'" />
</Frame>
...
<Frame>
  <img src="/docs/assets/images/aws/09.launch.png" alt="AWS dashboard showing an active instance" />
</Frame>
...
<Frame>
  <img src="/docs/assets/images/aws/10.enjoy.png" alt="Meilisearch local preview allowing users to search an example dataset" />
</Frame>
...
<Frame>
  <img src="/docs/assets/images/aws/11.domain.png" alt="An interface for editing DNS records with 'Type': A, 'Name': my-aws-instance, 'IPv4 address': 35.180.61.104, and 'TTL': Auto" />
</Frame>
