...
<Frame>
  <img src="/docs/assets/images/digitalocean/create.png" alt="Selecting 'Droplets' from the 'Create' dropdown" />
</Frame>
...
<Frame>
  <img src="/docs/assets/images/digitalocean/select-region.png" alt="Selecting the London data center region" />
</Frame>
...
<Frame>
  <img src="/docs/assets/images/digitalocean/marketplace.png" alt="Search results for 'Meilisearch' in Marketplace" />
</Frame>
...
<Frame>
  <img src="/docs/assets/images/digitalocean/select-plan.png" alt="Selecting the plan based on your usage" />
</Frame>
...
<Frame>
  <img src="/docs/assets/images/digitalocean/add-ssh-key.png" alt="Selecting SSH keys for authentication" />
</Frame>
...
<Frame>
  <img src="/docs/assets/images/digitalocean/droplet-name.png" alt="Adding 'meilisearch-droplet-name' as the hostname" />
</Frame>
...
<Frame>
  <img src="/docs/assets/images/digitalocean/add-tags.png" alt="The search bar, meilisearch, and search-team tags" />
</Frame>

### 7. Click on "Create Droplet"

<Frame>
  <img src="/docs/assets/images/digitalocean/01.create-droplet.png" alt="The 'Create Droplet' button" />
</Frame>
...
<Frame>
  <img src="/docs/assets/images/digitalocean/copy-ip.png" alt="meilisearch-droplet-name instance's IP: 165.227.56.77" />
</Frame>

Paste it into your browser. If you can access the local preview, Meilisearch is ready to use.

<Frame>
  <img src="/docs/assets/images/digitalocean/test-meili.png" alt="Meilisearch local preview" />
</Frame>
...
<Frame>
  <img src="/docs/assets/images/digitalocean/domain.png" alt="Selecting Domain/DNS from the Create menu" />
</Frame>

Type in your domain name in the "Enter domain field" and click "Add Domain".

<Frame>
  <img src="/docs/assets/images/digitalocean/add-domain.png" alt="Domains tab on the Networking page" />
</Frame>
