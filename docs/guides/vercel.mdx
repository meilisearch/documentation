...
<Frame>
  <img src="/docs/assets/images/vercel/01.create-new-project-on-vercel-dashboard.png" alt="Create a new project on Vercel dashboard" />
</Frame>
...
<Frame>
  <img src="/docs/assets/images/vercel/02.project-settings-integrations-tab.png" alt="Selecting the integration tab in the project settings" />
</Frame>
...
<Frame>
  <img src="/docs/assets/images/vercel/03.meilisearch-cloud-integration-page-in-marketplace.png" alt="Meilisearch integration page in Vercel's marketplace" />
</Frame>
...
<Frame>
  <img src="/docs/assets/images/vercel/04.add-meilisearch-cloud-form.png" alt="Form to add Meilisearch integration, the 'Specific projects' option is selected" />
</Frame>
...
<Frame>
  <img src="/docs/assets/images/vercel/05.create-a-meilisearch-cloud-project-form.png" alt="Meilisearch Cloud form to create a project complete, with 'search-app' as the project's name and 'Frankfurt' as the region" />
</Frame>
...
<Frame>
  <img src="/docs/assets/images/vercel/06.meilisearch-cloud-integration-page-in-vercel-dashboard.png" alt="Meilisearch integration page in Vercel's dashboard" />
</Frame>
...
<Frame>
  <img src="/docs/assets/images/vercel/07.project-settings-environment-variables-tab.png" alt="Display the environment variables in the project settings" />
</Frame>
...
<Frame>
  <img src="/docs/assets/images/vercel/08.meilisearch-cloud-dashboard.png" alt="Meilisearch Cloud dashboard: overview of the 'search-app' project" />
</Frame>
