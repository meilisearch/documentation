...
<Frame>
  <img src="/docs/assets/images/postman/import.png" alt="The 'Import' button" />
</Frame>

## Edit the configuration

<Frame>
  <img src="/docs/assets/images/postman/edit.png" alt="Selecting 'Edit' from the overflow menu" />
</Frame>

Set the "Token" if needed (set to `masterKey` by default):

<Frame>
  <img src="/docs/assets/images/postman/set_token.png" alt="The 'Token' field set to masterKey and 'Type' to Bearer Token in the 'Authorization' tab." />
</Frame>

Set `url` (set to Meilisearch's local port by default) and `indexUID` (set to `indexUID` by default):

<Frame>
  <img src="/docs/assets/images/postman/set_variables.png" alt="Setting the 'URL' to http://localhost:7700/ and 'indexUID' to indexUId in the Variables tab." />
</Frame>

The `url` and `indexUID` variables are used in all the collection routes, like in this one:

<Frame>
  <img src="/docs/assets/images/postman/url.png" alt="Highlighting {{url}} and {{indexUID}}" />
</Frame>
...
<Frame>
  <img src="/docs/assets/images/postman/create_index.png" alt="The 'Send' button" />
</Frame>
