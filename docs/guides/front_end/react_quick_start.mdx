...
<Frame>
  <img src="/docs/assets/images/react_quick_start/react-qs-search-ui.png" alt="React app search UI with a search bar at the top and search results for a few video games" />
</Frame>
