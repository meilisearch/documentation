...
<Frame>
  <img src="/docs/assets/images/strapi-v4/strapi-signup.png" alt="Strapi sign up form" />
</Frame>
...
<Frame>
  <img src="/docs/assets/images/strapi-v4/strapi-dashboard.png" alt="Strapi dashboard with side menu 'Content-Type Builder' option circled" />
</Frame>
...
<Frame>
  <img src="/docs/assets/images/strapi-v4/strapi-restaurant-content-type.png" alt="Strapi dashboard: Content manager side menu, arrow indicating the location of the Restaurant Collection Type" />
</Frame>
...
<Frame>
  <img src="/docs/assets/images/strapi-v4/strapi-add-category.png" alt="Strapi dashboard: create an entry form, arrow indicating the location of the categorie's location in the right side menu" />
</Frame>
...
<Frame>
  <img src="/docs/assets/images/strapi-v4/strapi-meilisearch-plugin.png" alt="Strapi dashboard with plugins side menu: arrow pointing at the 'meilisearch' option" />
</Frame>

Add your Meilisearch credentials on the Settings tab of the `meilisearch` plugin page.

<Frame>
  <img src="/docs/assets/images/strapi-v4/strapi-meilisearch-credentials.png" alt="Strapi dashboard with Meilisearch plugin selected: arrow pointing to the location of the settings tab" />
</Frame>
...
<Frame>
  <img src="/docs/assets/images/strapi-v4/add-collection-to-meilisearch.gif" alt="GIF showing the mouse clicking on 'restaurant' in the Meilisearch collections tab" />
</Frame>
...
<Frame>
  <img src="/docs/assets/images/strapi-v4/strapi-search-preview.gif" alt="GIF showing the word 'butter' being typed in the search bar and search results appearing instantly" />
</Frame>
