...
Download the following datasets: <a href="/docs/assets/datasets/crm-chats.json">`crm-chats.json`</a>, <a href="/docs/assets/datasets/crm-profiles.json">`crm-profiles.json`</a>, and <a href="/docs/assets/datasets/crm-tickets.json">`crm-tickets.json`</a> containing data from a fictional CRM application.
