...
<Frame>
  <img src="/assets/images/cloud-analytics/02-analytics-disable.png" alt="The analytics section of the project overview. It shows one button, 'Disable analytics and monitoring', and a short explanation of both features." />
</Frame>
