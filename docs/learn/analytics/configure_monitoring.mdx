...
<Frame>
  <img src="/docs/assets/images/cloud-analytics/01-analytics-enable.png" alt="The analytics and monitoring section of the project overview. It shows one button, 'Enable analytics and monitoring', and a short explanation of both features." />
</Frame>
