...
<Frame>
  <img src="/docs/assets/images/cloud-migration/1-new-project.png" alt="The Meilisearch Cloud menu, featuring the 'New Project' button" />
</Frame>
...
<Frame>
  <img src="/docs/assets/images/cloud-migration/2-import-dump.png" alt="A modal window with three mandatory fields: 'Project name', 'Select a region', and 'Select a plan'. Further down, an optional field: 'Import .dump'" />
</Frame>
