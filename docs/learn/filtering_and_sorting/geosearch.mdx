...
Using our <a id="downloadRestaurants" href="/docs/assets/datasets/restaurants.json" download="restaurants.json">example dataset</a>, we can search for places to eat near the center of Milan with `_geoRadius`:
...
With our <a id="downloadRestaurants" href="/docs/assets/datasets/restaurants.json" download="restaurants.json">restaurants dataset</a>, the results look like this:
