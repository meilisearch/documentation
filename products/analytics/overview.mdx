...
<Note>
Analytics is a Meilisearch Cloud feature. Self-hosted users can integrate with third-party analytics tools.
</Note>

## Key features

<CardGroup cols={2}>
  <Card title="Search analytics" icon="chart-line" href="/products/analytics/configure_analytics_events">
...
<CardGroup cols={2}>
  <Card title="Configure events" icon="gear" href="/products/analytics/configure_analytics_events">
