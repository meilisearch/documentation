...
Meilisearch does not have access to this information by default. You must [configure your application to submit click events](/products/analytics/configure_analytics_events) to Meilisearch if you want to track it in the Meilisearch Cloud interface.
...
You must explicitly [configure your application to send conversion](/products/analytics/configure_analytics_events) events when conditions are met.
