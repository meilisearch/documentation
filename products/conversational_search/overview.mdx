...
<CardGroup cols={2}>
  ...
  <Card title="OpenAI-compatible API" icon="plug" href="/products/conversational_search/chat_tooling_reference">
    Works with OpenAI SDKs and any OpenAI-compatible client.
  </Card>
  <Card title="Multiple LLM providers" icon="brain">
    Use OpenAI, Mistral, Gemini, Azure OpenAI, or vLLM.
  </Card>
...
<CardGroup cols={2}>
  ...
  <Card title="Chat API reference" icon="code" href="/products/conversational_search/chat_tooling_reference">
    Complete API documentation
  </Card>
  <Card title="Configure chat settings" icon="gear" href="/reference/api/settings/get-chat">
