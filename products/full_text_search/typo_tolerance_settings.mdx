...
You can disable typo tolerance for a specific [document attribute](getting_started/documents) by adding it to `disableOnAttributes`. The code sample below disables typo tolerance for `title`:
