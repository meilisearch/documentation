...
In Meilisearch Cloud, enable the personalization experimental feature in your project settings and configure your Cohere API key.

<Tabs>
  <Tab title="Cloud">
    Enable personalization in your project's **Settings** > **Experimental features** panel and add your Cohere API key.
  </Tab>
