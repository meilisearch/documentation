...
## Using Hugging Face embedders

For Hugging Face models, use [HuggingFace Inference Endpoints with the REST embedder](/guides/ai_embedders/providers/huggingface). This approach works with Meilisearch Cloud and provides better scalability than running models locally.
