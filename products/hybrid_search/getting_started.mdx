...
description: Hybrid search uses LLMs to retrieve search results. This tutorial shows you how to configure an OpenAI embedder and perform your first search.
---
...
First, create a new Meilisearch project. If this is your first time using Meilisearch, follow the [quick start](/getting_started/overview) then come back to this tutorial.
...
Replace `OPEN_AI_API_KEY` with your [OpenAI API key](https://platform.openai.com/api-keys).
...
You have created an index, configured an OpenAI embedder, generated embeddings from your documents, and performed your first AI-powered search.

## Next steps

<CardGroup cols={2}>
  <Card title="Embedder provider guides" icon="plug" href="/guides/ai_embedders/providers/openai">
    Set up embedders with OpenAI, Cohere, Mistral, and other providers
  </Card>
  <Card title="Hybrid search overview" icon="magnifying-glass" href="/products/hybrid_search/overview">
    Learn how semantic and full-text search work together
  </Card>
  <Card title="Embedder settings API" icon="gear" href="/reference/api/settings/get-embedders">
    Full API reference for configuring embedders
  </Card>
  <Card title="Hybrid search parameter" icon="code" href="/reference/api/indexes/search-with-post#hybrid-search">
    Control semantic vs. full-text balance with `semanticRatio`
  </Card>
</CardGroup>
