...
To filter search results based on their timestamp, add your document's timestamp field to the list of [`filterableAttributes`](/reference/api/settings/filterable-attributes#update-filterable-attributes):
...
To sort search results chronologically, add your document's timestamp field to the list of [`sortableAttributes`](/reference/api/settings/sortable-attributes#update-sortable-attributes):
