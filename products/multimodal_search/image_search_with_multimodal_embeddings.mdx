...
Once your embedder is configured, you can [add documents to your index](/getting_started/overview) with the [`/documents` endpoint](/reference/api/documents/overview).
