...
If you prefer to access the settings API directly through your console, you can also [configure index settings using the Meilisearch Cloud API](/products/indexing/configuring_index_settings_api).
