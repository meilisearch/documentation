...
In this example: `(542M - 350M) / 542M = 35%` overhead — compaction recommended.
...
Compaction is an [asynchronous operation](/products/platform/tasks). Track progress using the returned `taskUid`.
...
- [Compact API reference](/reference/api/compact-an-index/overview)
- [Stats API reference](/reference/api/stats/overview)
