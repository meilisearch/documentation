...
You must generate tokens in your application. Learn how to [generate tenant tokens](/products/platform/generate_tenant_tokens) using an official SDK or a third-party JWT library.
