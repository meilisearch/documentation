...
The master key is the first and most important step to secure your Meilisearch project. Meilisearch Cloud automatically generates a master key for each project, so your projects are secure by default.

View your master key by visiting your project settings, then clicking "API Keys" on the sidebar:
