# AI Agent Instructions for Meilisearch Documentation
...
- Mintlify navigation rules and limitations
- docs.json configuration
- Component usage guide
- Writing standards
- Common tasks (add/move/rename pages)
...
| List all open | `bd list --status open --json` |
