...
<Featured items={[
  {
    content: (
        <>
          <h2 style={{marginBottom: "-10px"}}>Quick start</h2> New here? Check out our quick start guide to learn how to set up Meilisearch, add data, and make your first search.
        </>
      ),
    size: 4,
