...
Puffin is an instrumentation profiler for Rust applications. Use this feature when trying to diagnose performance issues during indexing. Avoid enabling Puffin reports in production, as it might affect the performance of other Meilisearch operations.
