...
Some experimental features can be activated via an HTTP call using the [`/experimental-features` API route](/reference/api/experimental_feature):
...
|----------------------------------------------------------------------------------|------------------------------------------------------------|---------------------------------------------------|
| [Limit task batch size](/learn/experimental/max_number_of_batched_taskswrong)         | Limits number of tasks processed in a single batch         | At launch with a CLI flag or environment variable |
