---
title: Reduce indexing memory usage — Meilisearch documentation
description: The --experimental-reduce-indexing-memory-usage enables MDB_WRITEMAP, which can improve performance in some UNIX and UNIX-like setups.
---
