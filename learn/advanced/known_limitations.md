...
**Explanation:** Meilisearch limits the total number of returned search results to protect your database from malicious scraping. There is no way to access search results past this limit, but you _can_ change it using the `maxTotalHits` property of the [pagination index settings](/reference/api/pagination.md#maxtotalhits).
