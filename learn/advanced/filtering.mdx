...
<<<<<<< HEAD:learn/advanced/filtering.mdx
...
>>>>>>> 9a5182663 (update datasets urls):learn/advanced/filtering_and_faceted_search.mdx

<CodeSamples id="geosearch_guide_filter_usage_1" />

[Read more about filtering results with `_geoRadius` and `_geoBoundingBox` in our geosearch guide.](/learn/advanced/geosearch#filtering-results-with-georadius-and-geoboundingbox)
...
<<<<<<< HEAD:learn/advanced/filtering_and_faceted_search.mdx
<<<<<<< HEAD
=======
...
=======
>>>>>>> 3fedb941d (migrate v1.1 changes):learn/advanced/filtering.mdx
=======
...
=======
[You can read more about nested fields in our guide on data types.](/learn/inner_workings/datatypes)
>>>>>>> af33ece30 (update broken links)
=======
[You can read more about nested fields in our guide on data types.](/learn/advanced/datatypes)
>>>>>>> dceda9d0c (Revert "Migration: update broken links")
