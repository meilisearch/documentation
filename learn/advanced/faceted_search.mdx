...
Suppose you have a <a id="downloadBooks" href="https://raw.githubusercontent.com/meilisearch/documentation/new-docs-content-migration/assets/datasets/books.json" download="https://raw.githubusercontent.com/meilisearch/documentation/new-docs-content-migration/assets/datasets/books.json">books dataset</a> containing the following fields:
