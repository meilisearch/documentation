...
description: Use the master key to create, update, and delete API keys with granular permissions.
---

# Managing API keys with the API

Meilisearch gives you fine-grained control over which users can access which indexes, endpoints, and routes.
