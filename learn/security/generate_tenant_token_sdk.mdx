...
import CodeSamplesTenantTokenGuideGetKey1 from '/snippets/generated-code-samples/code_samples_tenant_token_guide_get_key_1.mdx';
...
Next, find your default search API key. Query the [get an API key endpoint](/reference/api/keys/get-api-key) and inspect the `uid`  field to obtain your API key's UID:

<CodeSamplesTenantTokenGuideGetKey1 />
