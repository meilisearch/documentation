...
| [Allowed IP networks](/learn/self_hosted/configure_meilisearch_at_launch#allow-requests-to-private-networks)    | Allow requests to private networks                                         | CLI flag or environment variable            |
