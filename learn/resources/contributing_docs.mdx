...
The Meilisearch documentation is built with [Mintlify](https://mintlify.com). You can run a local preview to see your changes before opening a pull request.

**Running the docs in dev mode**
...
3. Open [http://localhost:3000](http://localhost:3000) in your browser. The preview updates automatically when you edit the MDX files.
