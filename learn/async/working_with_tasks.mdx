...
import AddMoviesJson1 from '/snippets/add_movies_json_1.mdx';
...
![](/assets/images/cloud-tasks-tutorial/01-tasks-menu.png)

This will lead you to the task overview. Look for your request's `taskUid` in the "Uid" column:

![](/assets/images/cloud-tasks-tutorial/01-tasks-table.png)
