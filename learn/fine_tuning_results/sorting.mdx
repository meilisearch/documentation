---
title: Sorting — Meilisearch documentation
...
3. Update Meilisearch's [ranking rules](/learn/core_concepts/relevancy) (optional)
...
When users sort results at search time, [Meilisearch's ranking rules](/learn/core_concepts/relevancy) are set up so the top matches emphasize relevant results over sorting order. You might need to alter this behavior depending on your application's needs.
...
There is a lot of overlap between sorting and configuring [custom ranking rules](/learn/core_concepts/relevancy#custom-rules), as both can greatly influence which results a user will see first.
...
[You can read more about location-based sorting in our geosearch guide.](/learn/fine_tuning_results/geosearch#sorting-results-with-_geopoint)
...
The Meilisearch ecommerce demo uses sorting to allow users to sort products by price or rating. Check it out:
- [Ecommerce demo](https://ecommerce.meilisearch.com/?utm_campaign=oss&utm_source=docs&utm_medium=sorting)
- [Github repository](https://github.com/meilisearch/ecommerce-demo/)

<Capsule intent="tip" title="Looking to build this yourself?">
Read our [Step by step guide to adding site search to your Nuxt ecommerce](https://blog.meilisearch.com/nuxt-ecommerce-search-guide/?utm_campaign=oss&utm_source=docs&utm_medium=sorting).
</Capsule>
