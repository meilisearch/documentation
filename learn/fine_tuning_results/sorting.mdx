...
Meilisearch sorting applies equally to all documents. If you want to promote or pin specific documents so they are displayed more prominently than other search results, consult these Meilisearch blog articles on [implementing promoted search results with React InstantSearch](https://blog.meilisearch.com/promoted-search-results-with-react-instantsearch) and [implementing document boosting](https://blog.meilisearch.com/document-boosting).
</Capsule>
