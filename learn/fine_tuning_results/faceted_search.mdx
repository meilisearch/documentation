...
By default, all facet values are sorted in ascending alphanumeric order. You can change this using the using the `sortFacetValuesBy` property of the [`faceting` index settings](/reference/api/settings#faceting):
