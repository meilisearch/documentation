...
Internally, Meilisearch represents numbers as [`float64`](https://en.wikipedia.org/wiki/Double-precision_floating-point_format). Since they lack precision and can be written in different ways, Meilisearch does not support facet search on numbers.
</Capsule>
