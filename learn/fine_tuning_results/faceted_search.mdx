---
sidebarDepth: 3
description: Faceted search interfaces are provide users with a quick way to narrow down search results by selecting categories relevant to their query.
---
