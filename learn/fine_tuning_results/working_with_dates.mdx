---
description: Learn about Meilisearch's approach to date and time values, how to index documents with chronological data, and how to sort and filter search results based on time.
---
