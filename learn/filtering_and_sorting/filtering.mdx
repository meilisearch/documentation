...
[Read more about filtering results with `_geoRadius` and `_geoBoundingBox` in our geosearch guide.](/learn/filtering_and_sorting/geosearch#filtering-results-with-georadius-and-geoboundingbox)
