...
![The main menu of the project view in the Meilisearch Cloud interface. Menu itmes include "Indexes" among other options such as "Settings" and "Analytics".](/assets/images/cloud-index-settings/01-indexes-tab.png)
