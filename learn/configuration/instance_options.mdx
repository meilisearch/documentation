...
These startup options affect your entire Meilisearch instance, not just a single index. For settings that affect search within a single index, see [index settings](/learn/index_settings/settings).
...
- The [search preview interface](/learn/what_is_meilisearch/search_preview) is disabled
