...
If you manually configure [the searchable attributes list](/learn/configuration/displayed_searchable_attributes#the-searchableattributes-list), attributes that appear early in the array are more important when claculating search result relevancy.
