...
Results are sorted according to the **[attribute ranking order](/learn/relevancy/relevancy#attribute-ranking-order)**. Returns documents that contain query terms in more important attributes first.
...
The `attribute` rule sorts the results by [attribute importance](/learn/relevancy/relevancy#attribute-ranking-order).
