...
This chapter uses a dataset of meteorites to demonstrate filtering, sorting, and geosearch. To follow along, first click this link to download the file: <a id="downloadmeteorites" href="https://raw.githubusercontent.com/meilisearch/documentation/new-docs-content-migration/assets/datasets/meteorites.json" download="https://raw.githubusercontent.com/meilisearch/documentation/new-docs-content-migration/assets/datasets/meteorites.json">meteorites.json</a>. Then, move it into your working directory and run the following command:
