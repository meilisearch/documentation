---
title: Fine-tuning search results — Meilisearch documentation
description: This second article of the Meilisearch 101 series teaches you how to customize search relevancy with index settings.
---
...
You can read more about each ranking rule and what it does in our [dedicated guide](/learn/relevancy/ranking_rules).
...
You can read more about ranking rules in our [dedicated guide](/learn/relevancy/relevancy).
...
You can read more about displayed attributes in our [dedicated guide](/learn/relevancy/displayed_searchable_attributes#displayed-fields).
...
You can read more about the distinct attribute in our [dedicated guide](/learn/relevancy/distinct_attribute).
...
With the above order, matching words found in the `overview` field will have a higher impact on relevancy than the same words found in `title`. You can read more about this in our [relevancy guide](/learn/relevancy/attribute_ranking_order).
...
You can read more about it in our [dedicated guide](/learn/relevancy/synonyms).
...
You can read more about typo tolerance in our [dedicated guide](/learn/relevancy/typo_tolerance_settings).
...
Using the faceting settings, you can:

- Configure the maximum number of facet values returned for each facet
...
You can read more about faceting in our [dedicated guide](/learn/filtering_and_sorting/search_with_facet_filters).
