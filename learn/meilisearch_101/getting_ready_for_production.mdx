---
title: Getting ready for production — Meilisearch documentation
description: Learn about instance options, data backup, and multitenancy in this final article of the Meilisearch 101 series.
---
