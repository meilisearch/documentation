...
An [index](/learn/core_concepts/indexes) in Meilisearch is a collection of [documents](/learn/core_concepts/documents). Documents are composed of fields, each field containing an attribute and a value.
