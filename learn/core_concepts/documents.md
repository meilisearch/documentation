...
This means any progress the batch made before being canceled is lost and when the new batch is created, it may contain tasks that have been requested to be canceled in the meantime.
