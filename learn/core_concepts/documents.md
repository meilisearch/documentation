...
::: warning
If you get the [`missing_primary_key` error](/reference/api/errors.md#missing-primary-key), the primary key was not recognized. This means **your primary key is wrongly formatted or absent**.
:::
