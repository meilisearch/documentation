...
The attribute ranking order can also be set manually. For a more detailed look at this subject, see [the searchable attributes list](/learn/index_settings/displayed_searchable_attributes#the-searchableattributes-list).
