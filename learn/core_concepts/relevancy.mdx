...
Configure [the searchable attributes list](/learn/configuration/displayed_searchable_attributes#the-searchableattributes-list) to set the attribute ranking order manually.
