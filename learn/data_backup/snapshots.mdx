...
Since the `key` field depends on the master key, it is not propagated to snapshots. If a malicious user ever gets access to your snapshots, they will not have access to your instance's API keys.
</Capsule>
