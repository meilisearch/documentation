...
| Embedding Generation | ✅  <br /> OpenAI <br /> HuggingFace <br /> | Undisclosed | <br/> OpenAI <be /> Google PaLM <br /> GCP Vertex AI | ❌  |
| Prompt Embedding | ✅ | Undisclosed | ❌ | ❌ | 
...
| Monitoring Dashboard | ✅ <br /> [Cloud product](https://www.meilisearch.com/cloud) | ✅ <br /> Cloud Product | ✅ <br /> Cloud Product | ✅ <br /> Cloud Product |
