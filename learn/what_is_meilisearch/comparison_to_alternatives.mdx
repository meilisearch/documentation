...
| Compression Support | Gzip, Deflate, Brotli | Gzip | ❌ | Gzip | 
...
| Faceted search |  ✅ | 🔶 <br /> Faceted fields requires to be searchable | ✅ <br /> Faceting can take several seconds when >10 million facet values must be returned | ✅ |
...
| Embedding Generation | ✅  <br /> OpenAI <br /> HuggingFace <br /> | Undisclosed | <br/> OpenAI <br /> GCP Vertex AI | ❌  |
...
|---|:---:|:----:|:---:|:---:|
| Self-hosted | ✅  | ❌  | ✅  | ✅ |
| Platform Support | ARM <br /> x86 <br /> x64 | n/a | 🔶 ARM (requires Docker for macOS) <br /> x86 <br /> 64 | ARM <br /> x86 <br /> x64 |
