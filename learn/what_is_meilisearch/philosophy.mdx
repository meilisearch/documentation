...
Meilisearch should **not be your main data store**. Meilisearch should contain only the data you want your users to search through. If you must add data that is irrelevant to search, be sure to [make those fields non-searchable](/learn/index_settings/displayed_searchable_attributes#searchable-fields) to improve relevancy and response time.
