...
You can also **configure the [search parameters](/reference/api/search)** to refine your search even further. We support [filters](/learn/fine_tuning_results/filtering) and [faceting](/learn/fine_tuning_results/faceted_search#faceted-search).
