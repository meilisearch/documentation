...
- **Highly customizable search and indexing**: Customize search behavior to better meet your needs
  ...
  - [Filtering](/learn/filtering_and_sorting/filter_search_results) and [faceted search](/learn/fine_tuning_results/faceted_search): Enhance user search experience with custom filters and build a faceted search interface in a few lines of code
