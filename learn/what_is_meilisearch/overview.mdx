...
- **Search as you type**: Results are updated on each keystroke. To make this possible, we use [prefix-search](/learn/advanced/prefix#prefix-search).
- [Typo tolerance](/learn/configuration/typo_tolerance): Understands typos and misspellings.
- [Comprehensive language support](/learn/what_is_meilisearch/language) for **English**, **Chinese**, and **all languages that use space as a word divider**.
...
- **Highly customizable search and indexing**:
  ...
  - [Faceting](/learn/advanced/faceted_search): Classify search results into categories and build intuitive navigation interfaces.
  - [Filtering](/learn/advanced/filtering): Create filters to refine results based on user-defined criteria.
  ...
  - [Synonyms](//reference/api/settings#synonyms): Define synonyms for a better search experience.
- **RESTful API**
