...
- [Search as you type](/learn/what_is_meilisearch/features#search-as-you-type): Results are updated on each keystroke. To make this possible, we use [prefix-search](/learn/inner_workings/prefix#prefix-search).
- [Typo tolerance](/learn/what_is_meilisearch/features#typo-tolerant): Understands typos and misspellings.
- [Tokenization](/learn/inner_workings/tokenization) in **English**, **Chinese**, and **all languages that use space as a word divider**.
