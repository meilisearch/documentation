...
- **Highly customizable search and indexing**: Customize search behavior to better meet your needs
  ...
  - [Filtering](/learn/filtering_and_sorting/filtering) and [faceted search](/learn/filtering_and_sorting/faceted_search): Enhance user search experience with custom filters and build a faceted search interface in a few lines of code
