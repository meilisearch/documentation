...
- [Instant Meilisearch](https://github.com/meilisearch/meilisearch-js-plugins/tree/main/packages/instant-meilisearch): helps you integrate a great search experience with [`instantsearch.js`](https://www.algolia.com/doc/guides/building-search-ui/what-is-instantsearch/js/).
- [Autocomplete Client](https://github.com/meilisearch/meilisearch-js-plugins/tree/main/packages/autocomplete-client): helps you integrate a great search experience with [`autocomplete-js`](https://www.algolia.com/doc/ui-libraries/autocomplete/introduction/what-is-autocomplete/).
