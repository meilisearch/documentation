...
You can add [custom ranking rules](/learn/relevancy/relevancy#custom-rules) to create an ascending or descending sorting rule on a given attribute that has a numeric value in the documents.
