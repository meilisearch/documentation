...
**Explanation:** This limit exists to prevent Meilisearch from queueing an unlimited number of requests and potentially consuming an unbounded amount of memory. You may configure it with [`--experimental-search-queue-size`](/learn/experimental/search_queue_size).
