...
Enable Meilisearch Cloud analytics to gain insight on what your users are searching for, how often they find it, and whether they take any actions after clicking on search result.

## Requirements

You must have a [Meilisearch Cloud](https://meilisearch.com/cloud?utm_campaign=oss&utm_source=docs&utm_medium=analytics) account to have access to search analytics.
