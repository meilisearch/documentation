...
When creating dumps using Meilisearch versions below v0.21, all fields must be [displayed](/learn/index_settings/displayed_searchable_attributes#displayed-fields) in order to be saved in the dump.
