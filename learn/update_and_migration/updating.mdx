...
<Tip>
If you are running Meilisearch as a `systemctl` service, try our [migration script](https://github.com/meilisearch/meilisearch-migration).
</Tip>
...
Proceed to [creating the dump](/reference/api/backups/create-dump) (see the [create a dump endpoint](/reference/api/backups/create-dump)).
