...
In the "General settings" section, look for "Meilisearch version". This field shows your project's current Meilisearch version. If there's an update available, you will see a button next to the version number.
...
To update to the latest Meilisearch release, clicking the "Update to v.X.Y.Z" button. 
