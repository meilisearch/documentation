---
description: This article describes the system behind Meilisearch's SDK and engine version numbering, as well as compatibility between different releases.
---
