...
To follow along, first click this link to download the file: !BUTTONLINK!movies.json!BUTTONLINK!. Then, move the downloaded file into your working directory.
