...
[Meilisearch Cloud](https://www.meilisearch.com/cloud) is a cloud-based SaaS platform, built on top of the Meilisearch open-source search engine. It offers a managed search service that is scalable, reliable, and designed to meet the needs of all companies
