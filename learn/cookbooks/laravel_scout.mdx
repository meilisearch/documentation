...
<Capsule intent="tip">
Read the [Meilisearch Cloud quick start](/learn/getting_started/cloud_quick_start?utm_campaign=laravel&utm_source=docs&utm_medium=laravel-scout-guide).
</Capsule>

If you prefer to self-host, read our guide for [running Meilisearch in production](/learn/cookbooks/running_production?utm_campaign=laravel&utm_source=docs&utm_medium=laravel-scout-guide).
