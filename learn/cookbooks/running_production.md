...
::: tip
For more information on Meilisearch security and API keys see the [security docs](/learn/security/master_api_keys.md). For more information on Meilisearch options and flags see the [installation docs](/learn/getting_started/installation.md#download-and-launch).
:::
