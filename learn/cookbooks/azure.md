...
- **Meilisearch_apikey**: This will be the [master key](/learn/advanced/security.md) of your Meilisearch instance. While we generate a random key by default, we encourage you to set your own key.
