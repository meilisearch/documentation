...
All the code in this guide is a simplified example of what we implemented in our [Laravel CRM](https://saas.meilisearch.com/?utm_campaign=oss&utm_source=docs&utm_medium=laravel-multitenancy) example application. You can find the full code in our [GitHub repository](https://github.com/meilisearch/saas-demo).
