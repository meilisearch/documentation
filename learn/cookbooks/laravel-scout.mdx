...
This guide will help you to configure Laravel Scout to use Meilisearch to power full-text search in your Laravel 10 applications.

## Prerequisites

Before you start, make sure you have the following installed on your machin:
- PHP
...
Laravel comes with out-of-the-box full-text search capabilities via [Laravel Scout](https://laravel.com/docs/10.x/scout).
...
Let’s configure Laravel Scout to use the Meilisearch driver. First, install the dependencies required to use Scout with Meilisearch via Composer:
...
<Capsule intent="tip">
This comes from Docker [Bridge network driver](https://docs.docker.com/network/drivers/bridge/#differences-between-user-defined-bridges-and-the-default-bridge) behavior.
</Capsule>
...
<Capsule intent="tip">
Learn [how to get started with Meilisearch Cloud](/learn/getting_started/cloud_quick_start?utm_campaign=laravel&utm_source=docs&utm_medium=laravel-scout-guide).
</Capsule>

## Making Eloquent models searchable

With Scout installed and configured, add the `Laravel\Scout\Searchable` trait to your Eloquent models to make them searchable. 🎉

This trait will use Laravel’s model observers to keep the data in your model in sync with Meilisearch.
...
Configure which attributes are [filterable](/learn/fine_tuning_results/filtering?utm_campaign=laravel&utm_source=docs&utm_medium=laravel-scout-guide) and [sortable](/learn/fine_tuning_results/sorting?utm_campaign=laravel&utm_source=docs&utm_medium=laravel-scout-guide) via your Meilisearch index settings.
...
We built an example application to demonstrate how to use Meilisearch with Laravel Scout. It showcases an app-wide search in a CRM (Customer Relationship Management) application.
...
- [Multi-search](/reference/api/multi_search?utm_campaign=laravel&utm_source=docs&utm_medium=laravel-scout-guide) (search across multiple indexes)
- [Multi-tenancy](/learn/security/tenant_tokens?utm_campaign=laravel&utm_source=docs&utm_medium=laravel-scout-guide)
- [Filtering](/learn/fine_tuning_results/filtering?utm_campaign=laravel&utm_source=docs&utm_medium=laravel-scout-guide)
- [Sorting](/learn/fine_tuning_results/sorting?utm_campaign=laravel&utm_source=docs&utm_medium=laravel-scout-guide)
