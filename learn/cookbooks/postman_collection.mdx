...
Postman is a platform that lets you create HTTP requests you can easily reuse and share with everyone. We provide a <a href="/postman/meilisearch-collection.json" download="https://raw.githubusercontent.com/meilisearch/documentation/new-docs-content-migration/assets/misc/meilisearch-collection-postman.json">Postman collection</a> containing all the routes of the Meilisearch API! 🚀
