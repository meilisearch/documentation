---
description: Postman is a platform that lets you create HTTP requests you can easily reuse and share with everyone. This how-to guide explains how to use Postman to help testing and debugging Meilisearch's API.
---
