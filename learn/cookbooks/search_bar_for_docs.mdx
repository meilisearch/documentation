---
description: Use Meilisearch to index content in a text-heavy website. Covers installing Meilisarch, configuring a text scraper, and creating a simple front end.
---
...
We provide a few [other installation methods](/learn/getting_started/quick_start#setup-and-installation).
...
_More about [Meilisearch security](/learn/security/master_api_keys)._
...
Read more about [Meilisearch security](/learn/security/master_api_keys).
