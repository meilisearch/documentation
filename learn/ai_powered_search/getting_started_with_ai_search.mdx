...
<Frame>
  <img 
    src="https://raw.githubusercontent.com/meilisearch/documentation/main/assets/images/vector-search/01-cloud-vector-store.png"
    alt="A section of the project overview interface titled 'Experimental features'. The image shows a few options, including 'Vector store'."
  />
</Frame>
