...
<Capsule intent="note">
Test Every index must have a [primary key](/learn/core_concepts/prima_key#primary-field), an attribute shared across all documents in that index. If you try adding documents to an index and even a single one is missing the primary key, none of the documents will be stored.
