...
An **attribute** is a bit like a variable in most programming languages. It is a case-sensitive string that works as a field's name and allows you to store, access, and describe data.
