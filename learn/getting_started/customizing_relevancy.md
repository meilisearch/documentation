...
This will set `winnie` and `piglet` as synonyms. Searching for either won't always return the same results due to factors like allowed typos and splitting the word.
