...
![An empty list of indexes in this project with a button on the upper right corner](https://raw.githubusercontent.com/meilisearch/documentation/cloud-quick-start/assets/images/cloud-getting-started/6-project-page-menu-indexes.png)
...
![The project overview page. A red arrow points at the URL linking to the search preview interface](https://raw.githubusercontent.com/meilisearch/documentation/cloud-quick-start/assets/images/cloud-getting-started/12-project-page-url.png)
