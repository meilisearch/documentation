...
<Frame caption="The Meilisearch Cloud menu, featuring the 'New Project' button">
  <img src="/assets/images/cloud-getting-started/1-new-project.png" />
</Frame>

Name your project `meilisearch-quick-start` and select the region closest to you, then click on "Create project":

<Frame caption="A modal window with two mandatory fields: 'Project name' and 'Select a region'">
  <img src="/assets/images/cloud-getting-started/2-create-project.png" />
</Frame>
...
<Frame caption="A variation of the previous modal window with an extra mandatory field: 'Select a plan'. There are a few billing plan options">
  <img src="/assets/images/cloud-getting-started/3-project-billing.png" />
</Frame>
...
<Frame caption="Meilisearch Cloud's main list of projects. It features only one project, 'meilisearch-quick-start', and shows information such as API keys, URL, and number of monthly searches">
  <img src="/assets/images/cloud-getting-started/4-project-list.png" />
</Frame>
...
<Frame caption="The project overview page, featuring a secondary menu with several links. A red arrow points at a menu item: 'Indexes'">
  <img src="/assets/images/cloud-getting-started/5-project-page-menu-indexes.png" />
</Frame>

This leads you to the index listing. Click on "New index":

<Frame caption="An empty list of indexes in this project with a button on the upper right corner">
  <img src="/assets/images/cloud-getting-started/6-index-list-empty.png" />
</Frame>

Write `movies` in the name field and click on "Create Index":

<Frame caption="A modal window with one mandatory field: 'Index name'">
  <img src="/assets/images/cloud-getting-started/7-create-index.png" />
</Frame>

The final step in creating an index is to add data to it. Choose "File upload":

<Frame caption="Another modal window with three options. A red arrow points at the chosen option, 'File upload'">
  <img src="/assets/images/cloud-getting-started/8-file-upload.png" />
</Frame>
...
<Frame caption="Another modal window with a large drag-and-drop area. It indicates a file named 'movies.json' will be uploaded">
  <img src="/assets/images/cloud-getting-started/9-data-import.png" />
</Frame>
...
<Frame caption="A list of all indexes in this project. It shows a single index, `movies`, and indicates it contains over 30,000 documents">
  <img src="/assets/images/cloud-getting-started/10-index-list-filled.png" />
</Frame>
...
<Frame caption="The index list page. A red arrow points at the breadcrumb menu">
  <img src="/assets/images/cloud-getting-started/11-index-list-breadcrumb.png" />
</Frame>

Meilisearch Cloud comes with a search preview interface. Click on "Search preview" to access it:

<Frame caption="The project overview page. A red arrow points at a menu item named 'Search preview'">
  <img src="/assets/images/cloud-getting-started/12-project-page-url.png" />
</Frame>
...
<Frame caption="The search preview interface, with 'solaris' written in the search bar">
  <img src="/assets/images/cloud-getting-started/13-search-preview.png" />
</Frame>
