...
Whether you are using [Meilisearch Cloud](https://www.meilisearch.com/pricing?utm_campaign=oss&utm_source=docs&utm_medium=search-preview) or self-hosting Meilisearch, you can use the search preview for quick manual tests.
