...
If the provided [binaries](/learn/getting_started/installation.md#local-installation) do not work on your operating system, try building Meilisearch [from source](#local-installation). If compilation fails, Meilisearch is not compatible with your machine.
