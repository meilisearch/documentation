...
1. **Index your data** in Meilisearch with [AI-powered search](/products/hybrid_search/getting_started)
...
- [Chat API reference](/products/conversational_search/chat_tooling_reference): RAG endpoint documentation
- [AI-powered search](/products/hybrid_search/getting_started): Configure retrieval for RAG
