...
An [index](/resources/glossary/indexes) in Meilisearch is a collection of [documents](/resources/glossary/documents). Documents are composed of fields, each field containing an attribute and a value.
