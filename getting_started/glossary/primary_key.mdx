...
An [index](getting_started/indexes) in Meilisearch is a collection of [documents](getting_started/documents). Documents are composed of fields, each field containing an attribute and a value.
