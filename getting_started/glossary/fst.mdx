...
- [Inverted index](/resources/glossary/inverted_index): Maps words to documents
- [Tokenization](/resources/glossary/tokenization): Creates words stored in the FST
- [Typo tolerance](/resources/glossary/typo_tolerance): Uses FST for fuzzy matching

## Learn more

- [fst crate](https://github.com/BurntSushi/fst): Rust FST library used by Meilisearch
- [Typo tolerance settings](/reference/api/settings/typo-tolerance): Configure fuzzy matching
