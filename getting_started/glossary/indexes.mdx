...
You can set the primary key for an index or let it be inferred by Meilisearch. Read more about [setting the primary key](getting_started/primary_key#setting-the-primary-key).

[Learn more about the primary field](getting_started/primary_key)
