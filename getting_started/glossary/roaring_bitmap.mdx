...
Each word in the [inverted index](/getting_started/glossary/inverted_index) maps to a roaring bitmap of document IDs:

```
"coffee" → RoaringBitmap[1, 3, 5, 8, 12, ...]
```
...
- [Inverted index](/getting_started/glossary/inverted_index): Uses roaring bitmaps for document lists
- [Hannoy](/resources/internals/hannoy): Uses roaring bitmaps for filtered search
- [FST](/getting_started/glossary/fst): Another compact data structure used in Meilisearch
