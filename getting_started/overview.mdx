...
<CardGroup cols={2}>
  <Card title="Start with Cloud" icon="cloud" href="/learn/getting_started/cloud_quick_start">
    Get started in minutes with Meilisearch Cloud
  </Card>
  <Card title="Self-host" icon="server" href="/learn/self_hosted/getting_started_with_self_hosted_meilisearch">
...
**Index once, access everywhere.** You push your content to Meilisearch. It stores the documents, generates vector embeddings, and builds the indexes needed to serve your data to both end users and AI systems.
