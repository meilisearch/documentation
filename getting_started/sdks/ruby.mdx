...
sidebarTitle: Ruby
description: Get started with Meilisearch using the Ruby SDK in 5 minutes.
---
...
[See the full Rails guide →](/guides/ruby_on_rails_quick_start)

## Next steps

<CardGroup cols={2}>
  <Card title="Rails integration" icon="gem" href="/guides/ruby_on_rails_quick_start">
