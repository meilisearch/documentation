...
- [Search preview](getting_started/search_preview): Allows you to test your search settings without implementing a front-end
...
- [Index swapping](getting_started/indexes#swapping-indexes): Deploy major database updates with zero search downtime
