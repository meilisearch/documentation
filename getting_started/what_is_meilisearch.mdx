...
- [AI-powered search](/products/ai_powered_search/getting_started): Use the power of AI to make search feel human
...
- [Comprehensive language support](/resources/language): Optimized support for **Chinese, Japanese, Hebrew, and languages using the Latin alphabet**
...
- [Geosearch](/products/geo_search/geosearch): Filter and sort results based on their geographic location
- [Index swapping](/resources/glossary/indexes#swapping-indexes): Deploy major database updates with zero search downtime
...
Meilisearch's ease-of-use goes hand-in-hand with ultra relevant search results. Meilisearch **sorts results according to a set of [ranking rules](/products/full_text_search/ranking_rules)**. Our default ranking rules work for most use cases as we developed them by working directly with our users. You can also **configure the [search parameters](/reference/api/search)** to refine your search even further.
