...
`<InstantSearch>` is the root provider component for the InstantSearch library. It takes two props: the `searchClient` and the [index name](/getting_started/glossary/indexes#index-uid).
