...
Once the indexing finishes, your restaurants are in Meilisearch. Access the [search preview](getting_started/search_preview) confirm everything is working correctly by searching for “butter”.
