...
- A running instance of Meilisearch (v >= 1.x). If you need help with this part, you can consult the [Installation section](/resources/self_hosting/install_meilisearch_locally).
...
Once the indexing finishes, your restaurants are in Meilisearch. Access the [search preview](/resources/self_hosting/search_preview) to confirm everything is working correctly by searching for “butter”.
