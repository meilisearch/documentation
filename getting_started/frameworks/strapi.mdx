...
Once the indexing finishes, your restaurants are in Meilisearch. Access the [search preview](/learn/getting_started/search_preview) to confirm everything is working correctly by searching for “butter”.
