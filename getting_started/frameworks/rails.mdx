...
[Create a project](https://cloud.meilisearch.com) in the Meilisearch Cloud dashboard. Check out our [getting started guide](/getting_started/cloud_quick_start) for step-by-step instructions.

If you prefer to use the self-hosted version of Meilisearch, you can follow the [quick start](https://www.meilisearch.com/docs/resources/self_hosting/getting_started) tutorial.
...
Then add your Meilisearch URL and [Default Admin API Key](/products/platform/basic_security#obtaining-api-keys). On Meilisearch Cloud, you can find your credentials in your project settings.
...
For testing purposes, you can explore the records using our built-in [search preview](/resources/archives/search_preview).
...
When you're ready to use your own data, make sure to configure your [index settings](/reference/api/settings/overview) first to follow [best practices](/guides/performance/indexing_best_practices). For a full configuration example, see the [meilisearch-rails gem README](https://github.com/meilisearch/meilisearch-rails?tab=readme-ov-file#%EF%B8%8F-settings).
