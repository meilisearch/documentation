...
<Tip>
Read the [Meilisearch Cloud quick start](/getting_started/cloud_quick_start).
</Tip>
...
Configure which attributes are [filterable](/products/faceted_search/filter_search_results) and [sortable](/products/faceted_search/sort_search_results) via your Meilisearch index settings.
...
- [Multi-search](/reference/api/multi-search/overview) (search across multiple indexes)
- [Multi-tenancy](/products/platform/multitenancy_tenant_tokens)
- [Filtering](/products/faceted_search/filter_search_results)
- [Sorting](/products/faceted_search/sort_search_results)
