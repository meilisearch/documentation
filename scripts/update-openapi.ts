/**
 * Download the latest Meilisearch OpenAPI spec, fix validation errors,
 ...
 * 4. Fetches code samples from all SDK repos
 * 5. Matches samples to operations and injects x-codeSamples
 * 6. Saves the enhanced spec to reference/openapi.json
 */
...
async function main(): Promise<void> {
  ...
  console.log("Meilisearch OpenAPI Spec Updater with SDK Code Samples");
  console.log("=".repeat(60));

  // Step 1: Get latest version and download OpenAPI spec
