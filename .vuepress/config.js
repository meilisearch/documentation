          ...
          children: [
            ...
            '/reference/keys',
            {
              ...
              children: [
                ...
                '/reference/displayed_attributes',
                '/reference/distinct_attribute',
                '/reference/filterable_attributes',
                '/reference/ranking_rules',
                '/reference/searchable_attributes',
                '/reference/sortable_attributes',
                '/reference/stop_words',
                '/reference/synonyms',
              ],
            },
            '/reference/stats',
