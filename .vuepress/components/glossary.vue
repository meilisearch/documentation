...
const glossary = {
    'field': "A field is composed of an <b>attribute</b> and its associated data. <br><br> Ex: <code>attribute: 'data'</code> <br><br> The collection of fields is a document.",
    ...
    'document identifier': 'The attribute in a document of its unique identifier. <br><br> Used by MeiliSearch to store the document. <br><br> Example: `movie_id` is the document identifier of a movie document.',
